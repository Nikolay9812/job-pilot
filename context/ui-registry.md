...
| Property         | Class                                                                                 |
| ---------------- | ------------------------------------------------------------------------------------- |
| Background       | Page `bg-background`; cards/header `bg-surface`; positive trend badges `bg-success-lightest`; negative trend badges `bg-surface-secondary`; activity rings `bg-info-light`, `bg-success-light`; activity empty state stays on `bg-surface` |
...
| Text - secondary | Stat labels `text-sm font-semibold leading-5 text-text-secondary`; helpers/timestamps `text-sm font-medium leading-5 text-text-muted`; activity empty state `text-sm font-medium leading-5 text-text-secondary`; chart labels `fill-chart-axis text-xs font-medium` |
